...
class ProfilingParser(ABC):
    """An abstract class for parsers of profiling data.
    ...
    def metrics(self) -> list:
        ...
        Returns:
            list: Metrics contained in the files processed by the parser.
        """
...
def parse_profiling_data(run_dirs: list, parser: ProfilingParser, varname, getvar) -> xr.Dataset:
    """
    Given a list of directories containing profiling data, parse the data and return it as a xarray dataset.

    :param run_dirs: list of directories to parse.
    :param parser: an instance of a ProfilingParser.
    :return: xarray dataset containing the profiling data.
    """
    datasets = []
